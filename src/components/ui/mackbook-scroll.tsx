...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="md:min-h-[200vh] flex flex-col items-center py-0 md:py-32 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
      ...
      <div className="h-[22rem] w-[32rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        ...
        {showGradient && (
          <div className="h-60 w-full absolute bottom-0 inset-x-0 bg-gradient-to-t dark:from-black from-white via-white dark:via-black to-transparent z-50"></div>
        )}
